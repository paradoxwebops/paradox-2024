...
export default function SchedulePage() {
  const table1: TableProps = {
    ...
    data: [
      [
        "Paradox Premier league 24 Cricket (Trials)",
        "Sangam Ground",
        "03:00 PM-06:30 PM",
      ],
      [
        "Paradox Badminton League Trials",
        "Badminton Court",
        "03:00 PM - 08:00 PM",
      ],
      [
        "Paradox Champion League Trials",
        "Football Ground",
        "05:30 PM - 08:00 PM",
      ],
      [
        "Instructors vs Students Cricket match",
        "Sangam Ground",
        "07:00 PM - 09:00 PM",
      ],
  ...
  const table2: TableProps = {
    ...
    data: [
      [
        "Paradox Premier league 24 Cricket",
        "Sangam Ground",
        "06:00 AM - 09:00 AM",
      ],
      ...
      [
        "Paradox Badminton League",
        "Badminton Court |New sports complex",
        "11:00 AM - 04:00 PM",
      ],
  ...
  const table3: TableProps = {
    ...
    data: [
      ...
      ["Compassionathon Day 1", "ICSR Room 2", "09:00 AM - 11:00 AM"],
      ["Research summit", "ICSR Room 3", "09:00 AM - 03:00 PM"],
      ["Academic Workshops", "RMN/RMJ", "10:00 AM - 06:00 PM"],
      ["Pitch-O-Con", "ICSR Room 1", "10:00 AM - 01:00 PM"],
      ...
      [
        "The Inter House Chess Championship 2024",
        "NAC 513 and NAC 514",
        "04:00 PM - 07:00 PM",
      ],
  ...
  const table4: TableProps = {
    ...
    data: [
      ...
      ["Logic Loom", "ICSR Room 2", "09:30 AM - 12:30 PM"],
      ["Ranneeti 3.0: BGMI", "RMN 101", "10:00 AM - 01:00 PM"],
      ...
      [
        "Launching startup by Wadhwani Foundation",
        "ICSR Room 3",
        "10:30 AM - 01:30 PM",
      ],
      ...
      ["Compassion-a-thon Day 2", "ICSR Room 2", "01:00 PM - 03:00 PM"],
      [
        "IPL Arena (Finals - Day 1)",
        "Biotech Seminar Hall",
        "01:30 PM - 03:30 PM",
      ],
      ["Clay Modeling", "CRC 203", "02:00 PM - 05:00 PM"],
      ["EncryptID", "ICSR Room 1", "02:00 PM - 03:30 PM"],
      ["Anubhuti", "CRC 204", "02:00 PM - 03:30 PM"],
      ["Lift Off", "TTJ Auditorium", "03:00 PM - 05:00 PM"],
      [
        "Pro Table Tennis Championship",
        "Table Tennis Hall | New sports complex",
        "03:00 PM - 05:00 PM",
      ],
