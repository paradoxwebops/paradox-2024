...
export default function FAQPage() {
  ...
  const eligibilityData = [
    {
      ...
      answer: 'A: Current students of the IIT Madras BS Degree Program in either Data Science or Electronic Science who have registered and received their Student Email ID and valid Student ID Card are eligible to attend Paradox 2024.'
    },
    {
  ...
  const datesVenuesData = [
    ...
    {
      question: 'Q: I have never been to Chennai and this is my first time traveling alone. How will I reach the campus?',
      answer: 'A: ...'
    },
    {
      question: 'Q: How do I make a payment? ',
    ...
    <div className="w-full">
      ...
      <Accordion variant="splitted">
        {eligibilityData.map(({question, answer}, ind) => {
          return (
            <AccordionItem key={`_${ind}`} aria-label="Accordion 1" indicator={<></>} classNames={{base: ["!bg-[#FAD0CF]", "!shadow-none"]}} title={question} children={answer} />
          )
        })}
      </Accordion>
