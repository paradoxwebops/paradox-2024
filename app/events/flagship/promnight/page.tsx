...
const second_font = Inter({
  weight: ["300", "400", "500", "600"],
  subsets: ["latin"],
});

const third_font = Zilla_Slab({
  weight: ["300", "400", "500", "600"],
  subsets: ["latin"],
});
...
const PromNightPagePill = ({ children }: { children: React.ReactNode }) => {
  return (
    <Card
      bgColor={rgba("#000000", 0.5)}
      className={`${second_font.className} font-bold !w-auto`}
    >
      {children}
    </Card>
  );
...
const PromNightPageCard = ({
  ...
  return (
    <Card bgColor={rgba("#ffffff", 0.1)} className={`!p-8 ${className ?? ""}`}>
...
export default function FlagshipEventPromNightPage() {
  return (
    <Card
      bgColor="#0F0F30"
      className={`${main_font.className} overflow-hidden text-white !p-0`}
    >
      ...
      <section
        className={`${third_font.className} grid flex-col justify-center lg:justify-start gap-12 p-6`}
      >
        ...
        <div className="max-lg:flex-col flex gap-6 w-full lg:max-w-[75%] justify-self-center items-start">
          <PromNightPageCard
            ...
            description={
              <>
                <div>
                  Prom night is a formal event. To maintain the elegance and
                  formality of the evening, please adhere to the following
                  guidelines:
                </div>
                <div className="my-4">
                  <h5 className="my-3 mt-6">For Boys:</h5>
                  <ul className="list-none">
                    <li>Formals: Shirt and pant tucked in with a belt.</li>
                    <li>
                      Formals with Blazer: Shirt and pant tucked in with a belt,
                      and a blazer on top.
                    </li>
                    <li>Three-Piece Suit: A proper three-piece suit.</li>
                  </ul>
                  <h5 className="my-3 mt-6">For Girls:</h5>
                  <ul className="list-none">
                    <li>
                      Formal Attire: Girls are expected to be properly dressed
                      in formal attire appropriate for the event.
                    </li>
                  </ul>
                  <h5 className="my-3 mt-6">For All Attendees:</h5>
                  <ul className="list-none">
                    <li>
                      Footwear: Flip flops and any type of casual footwear are
                      not permitted.
                    </li>
                  </ul>
                </div>
          ...
          <div
            className="flex flex-col gap-6 max-lg:flex-col-reverse max-lg:items-center w-full
                    "
          >
            <PromNightPageCard
              ...
              description={
                <div className="flex flex-col gap-4">
                  ...
                  <div className=" w-full flex justify-center items-center">
                    <Link className="w-full" href="/events/register/86">
              ...
              className="text-center w-[fit-content]"
            />
          ...
          <div className="w-full lg:max-w-[60%]">
            <PromNightPageCard
              ...
              description={
                <>
                  <div>
                    No Stag Entry: Entry to the prom is restricted to couples
                    only. Single attendees will not be admitted.
                  </div>
                  <div>
                    Eligibility: The prom is exclusively for IIT-Madras BS
                    degree students.
                  </div>
                </>
              }
