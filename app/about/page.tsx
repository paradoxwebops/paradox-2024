  ...
  [
    {
      ...
      shortText: () => (
        <>
          <p>
            <b>Paradox</b> is a unique and immersive fest celebrating the
            pioneering Bachelor of Science (BS) Degree in Data Science and
            Electronic science offered by IIT Madras
          </p>
        </>
      ),
      longText: () => (
        <>
          <p>
            <b>Paradox</b> is a unique and immersive fest celebrating the
            pioneering Bachelor of Science (BS) Degree in Data Science and
            Applications and Electronics Science offered by IIT Madras . This
            annual on-campus gathering embodies the very essence of its name - a
            program that bridges the gap between the flexibility of online
    ...
    },
    {
      ...
      longText: () => (
        <>
          ...
          <p>
            <b>Be dazzled by talent:</b> Witness and participate in mesmerizing
            dance performances, soulful music, and captivating plays that will
            leave you speechless.
          </p>
          <p>
            <b>Learn from the best:</b> Industry experts, renowned artists, IITM
            professors and thought leaders will share their knowledge and ignite
            your imagination in inspiring workshops and talks.
          </p>
          <p>
            <b>Explore the future:</b> See mind-blowing creations at interactive
            installations and exhibitions showcasing the fascinating blend of
            technology and art.
          </p>
          <p>
            <b>Connect with amazing people:</b> Make new friends from all over
            India, celebrate different cultures, and create memories that will
            last a lifetime.
          </p>
        </>
      ),
                        ...
                        <AnimatePresence mode="wait" key={`${ind}_${id}`}>
                          {
                            <motion.div
                              ...
                              animate={{
                                height: !hideComponent(hoverInd, id)
                                  ? "100%"
                                  : "200px",
                              }}
